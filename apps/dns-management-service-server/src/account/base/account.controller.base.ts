...
import { CloudflareConfigFindManyArgs } from "../../cloudflareConfig/base/CloudflareConfigFindManyArgs";
...
export class AccountControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/cloudflareConfigs")
  @ApiNestedQuery(CloudflareConfigFindManyArgs)
  @nestAccessControl.UseRoles({
    resource: "CloudflareConfig",
    action: "read",
    possession: "any",
  })
  async findCloudflareConfigs(
    @common.Req() request: Request,
    @common.Param() params: AccountWhereUniqueInput
  ): Promise<CloudflareConfig[]> {
    const query = plainToClass(CloudflareConfigFindManyArgs, request.query);
    const results = await this.service.findCloudflareConfigs(params.id, {
      ...query,
      select: {
        account: {
          select: {
  ...
  @common.Post("/:id/cloudflareConfigs")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async connectCloudflareConfigs(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CloudflareConfigWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      cloudflareConfigs: {
        connect: body,
  ...
  @common.Patch("/:id/cloudflareConfigs")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async updateCloudflareConfigs(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CloudflareConfigWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/cloudflareConfigs")
  @nestAccessControl.UseRoles({
    resource: "Account",
    action: "update",
    possession: "any",
  })
  async disconnectCloudflareConfigs(
    @common.Param() params: AccountWhereUniqueInput,
    @common.Body() body: CloudflareConfigWhereUniqueInput[]
  ): Promise<void> {
    const data = {
